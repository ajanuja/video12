  ...
  return (
    <div className="home">
        ...
        <div className="card-row" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 13rem)', gap: '50px', marginTop: '20px' }}>
          <div className="card" style={{ height: '10rem', borderBlockColor: 'black' }}>
            <div className="card-body">
              ...
              <i className="fas fa-chart-pie fa-fw me-3"></i><span>
      ...
      <div className='upmeeting'>
        ...
        <h5 >
        <h5 style={{ textDecoration: 'underline' ,marginLeft:'25vw'}} className="card-title">Upcoming Meet At Time
        </h5>
        </h5>
        <div className="date-time mt-3" style={{marginLeft:'24vw',border: 'black solid 1px',width:'19vw', padding: '8px', borderRadius: '10px'}}>
                <p>{currentDate.time}</p>
                <p>{`${currentDate.day}, ${currentDate.month} ${currentDate.year}`}</p>
        </div>
      </div>
